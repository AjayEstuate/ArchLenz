...
public class QueryController {
                ...
                for (int i = 1; i <= metaData.getColumnCount(); i++) {
                    ...
                    if (i == columnNum) {
                        ...
                        if (table != null && idName != null) {
                            ...
                            columnValue = downloadAPI ; //"View/Download Links for Blob"; // Replace this with actual view/download links
                        } else {
	...
	// Assume you have the ExternalTableConfig class with the method getResultSet()
}
